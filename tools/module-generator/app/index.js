...
module.exports = class SampleModule extends Generator {
  ...
  initializing() {
    // this.log("It looks like you are adding a new Sample module!")
  }
  ...
  writing() {
    ...
    src = path.join(this.basePath, "js/module.js")
    dest = src.replace("module.js", `${data.lib}.js`)
    this.fs.move(src, dest)
